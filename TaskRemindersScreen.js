...
const TaskRemindersScreen = () => {
  ...
  useEffect(() => {
    fetch('http://172.16.56.114:5000/reminders')
      .then(res => res.json())
      .then(data => {
        const taskOnly = data.filter(item => item.type === 'task');
        setTasks(taskOnly);
      })
      ...
      >
        <View style={styles.cardContent}>
          <View style={styles.taskInfo}>
            <Ionicons name="checkmark-circle" size={24} color="#73CECB" />
      ...
      <View style={styles.headerContainer}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerSubTitle}>Scheduled activities</Text>
          </View>
      ...
      <View style={styles.section}>
        {tasks.length > 0 ? (
          ...
          <View style={styles.emptyState}>
            <Image 
              source={require('./empty-tasks.png')} 
